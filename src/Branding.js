  ...
  return (
    <section ref={ref} id="branding" className={`relative ${isDark ? 'bg-slate-900' : 'bg-gray-50'} overflow-hidden transition-colors duration-300`}>
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-40 right-40 w-96 h-96 bg-[#ffa500] rounded-full blur-3xl"></div>
            ...
            <div className="relative h-[400px] sm:h-[500px] lg:h-[600px] rounded-3xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-12">
                <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-white leading-[0.9] mb-4">
                  ...
                  <span className="text-[#ffa500]">{t.brandingTitle.split(' ')[1]}</span>
                </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="relative text-center p-8 rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-4xl md:text-5xl font-black text-[#ffa500] mb-2">
                  <CountUp end={500} />
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className={`group relative ${isDark ? 'bg-white/5 hover:bg-white/10 border-white/10' : 'bg-white hover:shadow-2xl border-gray-200'} border rounded-2xl p-8 transition-all duration-300 hover:-translate-y-2`}>
                <div className="absolute top-0 left-0 w-1 h-full bg-[#ffa500] rounded-l-2xl transition-all duration-300"></div>
                <div className="w-14 h-14 bg-[#ffa500]/10 rounded-xl flex items-center justify-center mb-6 group-hover:bg-[#ffa500] transition-colors duration-300">
                  <svg className="w-7 h-7 text-[#ffa500] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <h3 className={`text-xl font-bold ${isDark ? 'text-white' : 'text-gray-900'} mb-3 group-hover:text-[#ffa500] transition-colors duration-300`}>{item.title}</h3>
      ...
      <div className={`relative z-10 py-16 sm:py-20 ${isDark ? 'border-t border-white/5' : 'border-t border-gray-200'}`}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="relative">
            ...
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-[#ffa500]/30 hidden md:block"></div>
              ...
              {[
                ...
                <div key={index} className="relative flex items-start gap-8">
                  ...
                  <div className="relative z-10 flex-shrink-0">
                    <div className="w-16 h-16 bg-[#ffa500] rounded-full flex items-center justify-center shadow-lg">
                  ...
                  <div className={`flex-1 ${isDark ? 'bg-white/5 hover:bg-white/10' : 'bg-white hover:shadow-xl'} rounded-2xl p-6 md:p-8 transition-all duration-300 group`}>
                    <h3 className={`text-xl md:text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-900'} mb-3 group-hover:text-[#ffa500] transition-colors`}>{item.title}</h3>
