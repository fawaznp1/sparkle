        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={item.id}>
                  <a href={`#${item.id}`} className={`${isDark ? 'text-white/60 hover:text-[#be185d]' : 'text-gray-600 hover:text-[#be185d]'} text-sm transition-colors flex items-center gap-2`}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:+1234567890" className={`${isDark ? 'text-white/60 hover:text-[#be185d]' : 'text-gray-600 hover:text-[#be185d]'} text-sm transition-colors flex items-center gap-2`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="#contact" className={`${isDark ? 'text-white/60 hover:text-[#be185d]' : 'text-gray-600 hover:text-[#be185d]'} text-sm transition-colors flex items-center gap-2`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
