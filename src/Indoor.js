        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div className="backdrop-blur-2xl bg-slate-800/40 border border-white/20 rounded-[20px] p-8">
                <h3 className="text-3xl font-bold text-white mb-6">Our Sign Solutions</h3>
                <div className="space-y-3">
                  {signTypes.map((type, i) => (
                    <div key={i} className="group backdrop-blur-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-purple-400/50 rounded-xl p-4 transition-all duration-300 hover:translate-x-2">
            ...
            <div className="backdrop-blur-2xl bg-slate-800/40 border border-white/20 rounded-[20px] p-6">
