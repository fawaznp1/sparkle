      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className={`backdrop-blur-2xl ${isDark ? 'bg-slate-800/40 border-white/20' : 'bg-white border-gray-200'} border rounded-[20px] p-8 md:p-12`}>
          ...
          <div className="relative h-[500px] max-w-4xl mx-auto">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 group">
              <div className="relative w-full h-full backdrop-blur-lg bg-white/5 border border-white/20 rounded-full overflow-hidden hover:scale-110 transition-all duration-500 cursor-pointer shadow-2xl">
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-56 h-56 group">
              <div className="relative w-full h-full backdrop-blur-lg bg-white/5 border border-white/20 rounded-full overflow-hidden hover:scale-110 transition-all duration-500 cursor-pointer shadow-2xl">
                <div className="absolute inset-0 flex items-center justify-center">
            ...
            <div className="absolute top-1/2 right-0 -translate-y-1/2 w-56 h-56 group">
              <div className="relative w-full h-full backdrop-blur-lg bg-white/5 border border-white/20 rounded-full overflow-hidden hover:scale-110 transition-all duration-500 cursor-pointer shadow-2xl">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-white/40 text-5xl">📊</div>
                </div>
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-60 h-60 group">
              <div className="relative w-full h-full backdrop-blur-lg bg-white/5 border border-white/20 rounded-full overflow-hidden hover:scale-110 transition-all duration-500 cursor-pointer shadow-2xl">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-white/40 text-5xl">📊</div>
                </div>
