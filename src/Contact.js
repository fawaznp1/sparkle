    ...
    <section className={`relative min-h-screen ${isDark ? 'bg-gradient-to-br from-slate-900 to-slate-900' : 'bg-gradient-to-br from-gray-50 to-white'} py-20 px-4 overflow-hidden transition-colors duration-300`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className={`text-5xl md:text-6xl font-black mb-6 ${isDark ? 'bg-gradient-to-r from-white via-purple-200 to-pink-200' : 'bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600'} bg-clip-text text-transparent`}>
            Like What We Have To Say?
          </h2>
          <p className={`${isDark ? 'text-white/90' : 'text-gray-700'} text-xl leading-relaxed max-w-3xl mx-auto mb-8`}>
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            <div className={`group backdrop-blur-2xl ${isDark ? 'bg-slate-800/40 border-white/20' : 'bg-white border-gray-200'} border rounded-[20px] p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl`}>
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className={`${isDark ? 'text-white/70' : 'text-gray-600'} mb-3`}>Drop us a line anytime</p>
            ...
            <div className={`group backdrop-blur-2xl ${isDark ? 'bg-slate-800/40 border-white/20' : 'bg-white border-gray-200'} border rounded-[20px] p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl`}>
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className={`${isDark ? 'text-white/70' : 'text-gray-600'} mb-3`}>Mon-Fri 9am-6pm</p>
            ...
            <div className={`group backdrop-blur-2xl ${isDark ? 'bg-slate-800/40 border-white/20' : 'bg-white border-gray-200'} border rounded-[20px] p-8 hover:scale-105 transition-all duration-300 hover:shadow-2xl`}>
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className={`${isDark ? 'text-white/70' : 'text-gray-600'} mb-3`}>Pop in for a cup of tea</p>
          ...
          <div className={`backdrop-blur-2xl ${isDark ? 'bg-gradient-to-br from-purple-500/20 to-pink-500/20 border-white/20' : 'bg-white border-gray-200'} border rounded-[20px] p-12 flex flex-col justify-center items-center text-center`}>
            <h3 className={`text-4xl font-black ${isDark ? 'text-white' : 'text-gray-900'} mb-6`}>
              LET'S TALK
            </h3>
            <p className={`${isDark ? 'text-white/90' : 'text-gray-700'} text-lg mb-8 max-w-md`}>
            ...
            <div className="flex gap-4 mt-8">
              {['📱', '💼', '🌐'].map((icon, i) => (
                <div key={i} className={`w-12 h-12 backdrop-blur-lg ${isDark ? 'bg-white/5 border-white/20 hover:bg-white/10' : 'bg-gray-200 border-gray-300 hover:bg-gray-300'} border rounded-full flex items-center justify-center hover:scale-110 transition-all duration-300 cursor-pointer`}>
